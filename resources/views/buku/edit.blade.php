                ...
                <form action="/buku/{{ $buku->id }}/update" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="id"type="text" value="{{ $buku->id }}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Nama Buku</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="nama_buku"type="text" value="{{ $buku->nama_buku }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Keterangan</label>
                        <div class="col-sm-12 col-md-10">
                        <textarea class="form-control" type="text" name="keterangan" >{{ $buku->keterangan }}"</textarea>
                        </div>
                    </div>
