    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                <form action="/bab/{{ $bab->id }}/update" method="POST">
                    @csrf

                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Nama Murid</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="id"type="text" value="{{ $bab->id }}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Nama Buku</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="id_buku"type="text" value="{{ $bab->id_buku }}" readonly>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="no_bab"type="text" value="{{ $bab->no_bab }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="nama_bab"type="text" value="{{ $bab->nama_bab }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                        <textarea class="form-control" type="text" name="keterangan" >{{ $bab->keterangan }}"</textarea>
                        </div>
                    </div>
