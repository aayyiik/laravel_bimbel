...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="title">
                            <h4>Data Anggota Bimbel Mentari</h4>
                        </div>
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Tambah Anggota Bimbel Mentari</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                ...
                <form action="/proses/user" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <select name="id_role" class="custom-select col-12">
        ...
        <div class="footer-wrap pd-20 mb-20 card-box">
             <a href="https://github.com/dropways" target="_blank">template</a>
        </div>
    </div>
</div>
