                            ...
                            <td style="">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list" style="">
                                        <a class="dropdown-item" href="ortu/{{$item->id}}/edit"><i class="dw dw-edit2"></i> Edit</a>
                                        <a class="dropdown-item" href="ortu/{{$item->id}}/delete"><i class="dw dw-delete-3"></i> Delete</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
