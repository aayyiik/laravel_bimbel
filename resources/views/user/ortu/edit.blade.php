                ...
                <form action="/ortu/{{ $ortu->id }}/update" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="nama"type="text" value="{{ $ortu->nama }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Jenis Kelamin</label>
                        <div class="custom-control custom-radio mb-5">
                            <input type="radio" id="gender4" name="gender" class="custom-control-input" value="M"  {{ $ortu->gender == 'M' ? 'checked' : ''}}>
                            <label class="custom-control-label" for="gender4">Laki-Laki</label>
                        </div>
                        <div class="custom-control custom-radio mb-5">
                            <input type="radio" id="gender5" name="gender" class="custom-control-input" value="F"  {{ $ortu->gender == 'F' ? 'checked' : ''}}>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="tgl_lahir" type="date" value="{{ $ortu->email}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">No Hp</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="hp"type="text" value="{{ $ortu->hp }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Status</label>
                        <div class="custom-control custom-radio mb-5">
                            <input type="radio" id="status4" name="status" class="custom-control-input" value=1  {{ $ortu->status == 1 ? 'checked' : ''}}>
                            <label class="custom-control-label" for="status4">Aktif</label>
                        </div>
                        <div class="custom-control custom-radio mb-5">
                            <input type="radio" id="status5" name="status" class="custom-control-input" value=0  {{ $ortu->status == 0 ? 'checked' : ''}}>
